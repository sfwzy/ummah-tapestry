    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        >
          ...
          >
            Recognizing Muslim excellence across all fields.
          </motion.p>
        </motion.div>
      </section>
            ...
            <div className="space-y-12">
              ...
              <div className="text-center mb-16">
                <div className="flex items-center justify-center space-x-3 mb-6">
                  ...
                  <h2 className="text-hero font-grotesk font-semibold text-foreground">Ummah100</h2>
                </div>
                <p className="text-large text-accent font-medium">
              ...
              <div className="bg-secondary/10 rounded-2xl p-8">
                <h3 className="text-hero font-grotesk font-semibold text-foreground mb-8">Why Ummah100?</h3>
                <div className="space-y-6">
                  <div className="flex items-start space-x-4">
                    <span className="text-accent font-bold">•</span>
                    <p className="text-body text-muted-foreground">To surface new role models for Muslims everywhere.</p>
                  </div>
                  <div className="flex items-start space-x-4">
                    <span className="text-accent font-bold">•</span>
                    <p className="text-body text-muted-foreground">To challenge and expand the narrative of who Muslims are and what they contribute.</p>
                  </div>
                  <div className="flex items-start space-x-4">
                    <span className="text-accent font-bold">•</span>
                    <p className="text-body text-muted-foreground">To build a global archive that documents, honors, and elevates Muslim excellence across disciplines.</p>
                  </div>
                  <div className="flex items-start space-x-4">
                    <span className="text-accent font-bold">•</span>
                    <p className="text-body text-muted-foreground">To create a rigorous, panel-driven recognition process that reflects fairness, credibility, and impact.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="text-center space-y-6">
                ...
                <div className="bg-accent/10 rounded-2xl p-8">
                  <p className="text-large font-medium text-accent mb-4">
                  ...
                  <p className="text-large font-grotesk font-bold text-foreground">
